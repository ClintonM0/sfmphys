...
class btShapeHull(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = ___init__.new_btShapeHull(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = ___init__.delete_btShapeHull
    __del__ = lambda self : None;
    def buildHull(self, *args): return ___init__.btShapeHull_buildHull(self, *args)
    def numTriangles(self): return ___init__.btShapeHull_numTriangles(self)
    def numVertices(self): return ___init__.btShapeHull_numVertices(self)
    def numIndices(self): return ___init__.btShapeHull_numIndices(self)
    def getVertexPointer(self): return ___init__.btShapeHull_getVertexPointer(self)
    def getIndexPointer(self): return ___init__.btShapeHull_getIndexPointer(self)
btShapeHull_swigregister = ___init__.btShapeHull_swigregister
...
def buildConvexHull(*args):
  return ___init__.buildConvexHull(*args)
buildConvexHull = ___init__.buildConvexHull

def shrinkConvexHull(*args):
  return ___init__.shrinkConvexHull(*args)
shrinkConvexHull = ___init__.shrinkConvexHull

def simplifyConvexHull(*args):
  return ___init__.simplifyConvexHull(*args)
simplifyConvexHull = ___init__.simplifyConvexHull
