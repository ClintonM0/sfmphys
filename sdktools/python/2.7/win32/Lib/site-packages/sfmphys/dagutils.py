...
from sfmphys import sessionutils
...
def GetValueAtTime(channel, time):
	clipstart = sessionutils.getCurrentShot().GetStartTime()
	start = channel.FindOwnerClipForChannel(sessionutils.getCurrentShot()).GetStartTime()
